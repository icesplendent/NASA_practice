<template>
  ...
  <div
    id="com"
    class="h-screen w-screen overflow-y-auto py-24 bg-[#434343] font-jura"
  >
    <div class="relative h-fit">
      ...
      <section>
        ...
        <img
          ...
          class="bg-cover ml-[52%] w-[16%] h-[16vh]"
        />
      </section>
      <section>
        ...
        <img
          src="../assets/slash2.png"
          class="bg-cover ml-[32%] mr-[52%] w-[16%] h-[16vh] flex flex-row-reverse"
        />
      </section>
      <section>
        <div class="flex">
      ...
      <div class="w-full m-auto flex justify-center mt-8">
        <router-link to="/game" class="z-50">
          <button
            class="bg-[#117090] text-[50px] py-4 px-8 rounded-full font-jura"
          >
            Trip to Earth →
          </button>
        </router-link>
